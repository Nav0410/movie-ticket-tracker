...
MOVIE_URL = os.getenv(
    "MOVIE_URL",
    "https://www.district.in/movies/korean-kanakaraju-movie-tickets-in-kurnool-MV213660",
)
TARGET_MOVIE_NAMES = (
    "korean kanakaraju",
    "korean kanagaraju",
...
TARGET_DATE_ISO = os.getenv("TARGET_DATE", "2026-08-06")
...
log = logging.getLogger("ticket-tracker")
...
def inspect_page(page: Page) -> dict[str, Any]:
    ...
    date_click = click_target_date(page)
    scroll_page(page)
    ...
    theatre_found = any(name in lower_section for name in TARGET_THEATRE_NAMES)
    ...
    return {
        ...
        "blocked": blocked,
        "booking_url": page.url or MOVIE_URL,
        "page_title": page.title(),
        "theatre_section_preview": section[:2_000],
